...
| Draft as of 2026-04-21 | *Computable Name*:CervicalCancerDAK |
...
```json
{
  ...
  "id" : "dhes.dak.cervical-cancer",
  "url" : "https://dhes.github.io/smart-dak-cervical-cancer/ImplementationGuide/dhes.dak.cervical-cancer",
  "version" : "0.1.0",
  "name" : "CervicalCancerDAK",
  "title" : "WHO SMART DAK — Cervical Cancer Screening (L2)",
  "status" : "draft",
  "date" : "2026-04-21T20:10:53+00:00",
  ...
  "description" : "Layer 2 (decision logic) artifacts for cervical cancer screening, Algorithm 5 (HPV DNA primary with VIA triage), authored using a textualist/purposive methodology with an interpretation register. L3 (FHIR profiles, CQL, terminology bindings) not yet authored.",
  "packageId" : "dhes.dak.cervical-cancer",
  "license" : "CC-BY-4.0",
  "fhirVersion" : ["4.0.1"],
  "dependsOn" : [{
    "id" : "hl7tx",
  ...
  "definition" : {
    ...
    },
    {
      ...
      {
        "url" : "value",
        "valueString" : "https://dhes.github.io/smart-dak-cervical-cancer/history.html"
      }],
      "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-parameter"
    },
    {
    ...
    "page" : {
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "register.html"
        }],
        "nameUrl" : "register.html",
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "cc-000.html"
        }],
        "nameUrl" : "cc-000.html",
        "title" : "cc-000: Scope Declaration",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "cc-001.html"
        }],
        "nameUrl" : "cc-001.html",
        "title" : "cc-001: Population and Inclusion",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "cc-002.html"
        }],
        "nameUrl" : "cc-002.html",
        "title" : "cc-002: WLHIV Operationalisation",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "cc-003.html"
        }],
        "nameUrl" : "cc-003.html",
        "title" : "cc-003: Cancer Suspected",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "cc-004.html"
        }],
        "nameUrl" : "cc-004.html",
        "title" : "cc-004: Vaccination Status",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "cc-005.html"
        }],
        "nameUrl" : "cc-005.html",
        "title" : "cc-005: Screening Interval",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "cc-006.html"
        }],
        "nameUrl" : "cc-006.html",
        "title" : "cc-006: Pregnancy Handling",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "cc-007.html"
        }],
        "nameUrl" : "cc-007.html",
        "title" : "cc-007: Sexual Exposure Precondition",
        "generation" : "markdown"
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "cc-008.html"
        }],
        "nameUrl" : "cc-008.html",
        "title" : "cc-008: HIV Status Absent/Unknown",
        "generation" : "markdown"
      },
      {
        "extension" : [{
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "README.html"
        }],
        "nameUrl" : "README.html",
        "title" : "Data Dictionary — README",
        "generation" : "markdown"
      },
      {
        "extension" : [{
      ...
      },
      {
        "extension" : [{
          "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
          "valueUrl" : "algorithm-selection.html"
        }],
        "nameUrl" : "algorithm-selection.html",
