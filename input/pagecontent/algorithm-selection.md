...
This document supports the scope declaration in [`../interpretation-register/cc-000-scope-declaration.md`](../interpretation-register/cc-000-scope-declaration.md), which discloses the choice of Algorithm 5 and its biases. That entry summarises; this document shows the work.
